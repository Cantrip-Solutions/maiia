...
<div class="small-header transition animated fadeIn">
    <div class="hpanel">
        <div class="panel-body">
            ...
            <h2 class="font-light m-b-xs"> Edit Banner  </h2>
        </div>
    </div>
</div>
        ...
        <div class="col-lg-12">
            ...
            <div class="hpanel">
                <div class="panel-body">
                    ...
                    {{Form::open(array('files'=>true,'id'=>'bannerdata','class'=>'form-horizontal','action' => 'BannerController@updateBanner','method'=>'POST','enctype'=>"multipart/form-data"))}}

                        <div class="form-group">
                            <label for="banner_title" class="col-sm-2 control-label">Banner Title *:</label>
                            <div class="col-sm-10">
                                {!! Form::text('title', $bannerInfo->title,array('placeholder'=>'Banner Title', 'class'=>'form-control')) !!}
                                @if ($errors->has('title'))
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                {!! Form::textarea('description', $bannerInfo->description,array('placeholder'=>'Banner Description', 'class'=>'form-control')) !!}
